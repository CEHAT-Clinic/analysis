...
#cleaned PM2.5 data
SGData <- PurpleAirCEHAT::hourlyPA(cleanPA(test))
SGData <- subset(SGData, select = -c(6,7,8,9,10))
...
otherCityData <- read.csv("centralLA_readings.csv")
...
boxplot(ourData$otherCityPM, ourData$southGatePM, main = "PM2.5 in Other City vs South Gate",
        names = c("Other City","South Gate"), ylim = c(0,100),outline=FALSE)
